...
if __name__ == '__main__':
    ...
    while True:
        ...
        for itinerary in data['data']:
            if str(itinerary['t_no']).lower().find(query_data.lower()) is not -1 or str(itinerary['t_pos_start']).lower().find(query_data.lower()) is not -1 or str(itinerary['t_pos_end']).lower().find(query_data.lower()) is not -1 or str(itinerary['t_date']).find(query_data) is not -1 :
